const fs = require("fs"); fs.writeFileSync("e:/Ameer/portfolio/client/src/components/Footer.jsx", `import React from "react";
    ...
    <footer className="border-t border-white/5 py-8 px-6">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-muted text-sm">
          ...
          <span className="text-primary">Node.js</span> &middot; Designed for AI roles
        </p>
